...
midpoint = [30]  # [25, 30, 35, 40, 45]  # stray_path.midpoint
b_stray_rel_overshoot = [1.5]

width = []  # [0.004]  # stray_path.width


N1 = np.arange(32, 33)  # Turns in main window
N2 = np.arange(7, 8)  #  Turns in main window
Ns1 = np.arange(0, 1)  # Turns in stray window
Ns2 = np.arange(6, 7)  #  Turns in stray window
