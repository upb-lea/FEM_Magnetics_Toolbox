...
class ItoOptuna:
    ...
    @classmethod
    def calculate_fix_parameters(cls, config: ItoSingleInputConfig):
    ...
    @staticmethod
    def objective(trial, config: ItoSingleInputConfig, target_and_fixed_parameters: ItoTargetAndFixedParameters):
    ...
    def start_study(self, study_name: str, config: ItoSingleInputConfig, number_trials: int, storage = None):
