...
for parameters in FEM_parameters:
    ...
    if do_simulate:
        ...
        geo.air_gaps.update(method="percent",
                            ...
                            air_gap_position=[parameters["midpoint"], 50])
        ...
        if inductance_calculation:
            ...
            # geo.single_simulation(freq=frequency, current=[I0, N1/N2*I0], phi_deg=[0, 180], skin_mesh_factor=skin_accuracy)
            geo.single_simulation(freq=frequency, current=[I0, 3.2*I0], phi_deg=[0, 180], skin_mesh_factor=skin_accuracy)
