...
def basic_example_inductor(onelab_folder: str = None, show_visual_outputs: bool = True, is_test: bool = False):
    def example_thermal_simulation(flag_insulation: bool = True, show_visual_outputs: bool = True):
        # Thermal simulation:
        ...
        geo.thermal_simulation(flag_insulation,thermal_conductivity_dict, boundary_temperatures, boundary_flags, case_gap_top,
    ...
    example_thermal_simulation(flag_insulation=True,show_visual_outputs=show_visual_outputs)
