...
def transformer_30_28_measurement(onelab_folder: str = None, show_visual_outputs: bool = True, is_test: bool = False):
    """
    ...
    # 2. set core and accessories parameters
    ...
    insulation.add_core_insulations(1.575e-3, 1.575e-3, 0.9e-3, 1e-3)
    # insulation of conductor
    insulation.add_winding_insulations([[0.05e-3, 0.095e-3],
                                        [0.095e-3, 0.05e-3]])
    # insulation of layer
    # insulation.add_air_conductor_insulations([[7.5e-5],
    #                                           [1.3e-4]])
    insulation.add_conductor_air_conductor_insulation([[1e-6],
                                              [1e-6]])
    insulation.add_kapton_insulation(add_kapton=True, thickness=0.1e-3)
    # 59-56 transformer
    ...
    # 109-49
    cells = winding_window.NHorizontalAndVerticalSplit(horizontal_split_factors=[0.1],
    ...
    cells[1].set_winding(winding2, 28, None, fmt.Align.ToEdges, fmt.ConductorDistribution.VerticalUpward_HorizontalRightward, zigzag=True)
    ...
    cells[0].set_winding(winding1, 30, None, fmt.Align.ToEdges, fmt.ConductorDistribution.VerticalUpward_HorizontalRightward, zigzag=True)
...
if __name__ == "__main__":
    transformer_30_28_measurement(show_visual_outputs=True)
