...
def basic_example_transformer_intergrated(onelab_folder: str = None, show_visual_outputs: bool = True, is_test: bool = False):
    ...
    geo.single_simulation(freq=250000, current=[8.0, 4.0], phi_deg=[0, 180], show_fem_simulation_results=show_visual_outputs)
...
if __name__ == "__main__":
    basic_example_transformer_intergrated(show_visual_outputs=True)