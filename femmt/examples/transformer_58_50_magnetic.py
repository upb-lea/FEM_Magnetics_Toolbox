...
def basic_example_transformer_85_50_magnetic(onelab_folder: str = None, show_visual_outputs: bool = True, is_test: bool = False):
    """
    ...
    # 109-49
    cells = winding_window.NHorizontalAndVerticalSplit(horizontal_split_factors=[0.185],
    ...
    cells[1].set_winding(winding2, 50, None, fmt.Align.ToEdges, fmt.ConductorDistribution.VerticalUpward_HorizontalRightward, zigzag=True)
    ...
    cells[0].set_winding(winding1, 58, None, fmt.Align.ToEdges, fmt.ConductorDistribution.VerticalUpward_HorizontalRightward, zigzag=True)
