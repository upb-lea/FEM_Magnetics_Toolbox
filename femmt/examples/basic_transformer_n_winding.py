...
def basic_example_transformer_n_winding(onelab_folder: str = None, show_visual_outputs: bool = True,
    ...
    cells[0].set_winding(winding1, 9, fmt.WindingType.Single, fmt.PeripheralConductorDistribution.VerticalUpward_HorizontalRightward)
    cells[1].set_winding(winding2, 10, fmt.WindingType.Single, fmt.PeripheralConductorDistribution.VerticalUpward_HorizontalRightward)
    cells[2].set_winding(winding3, 9, fmt.WindingType.Single, fmt.PeripheralConductorDistribution.VerticalUpward_HorizontalRightward)
    cells[3].set_winding(winding4, 7, fmt.WindingType.Single, fmt.PeripheralConductorDistribution.VerticalUpward_HorizontalRightward)
    cells[4].set_winding(winding5, 12, fmt.WindingType.Single, fmt.PeripheralConductorDistribution.VerticalUpward_HorizontalRightward)
    cells[5].set_winding(winding6, 9, fmt.WindingType.Single, fmt.PeripheralConductorDistribution.VerticalUpward_HorizontalRightward)
    cells[6].set_winding(winding7, 9, fmt.WindingType.Single, fmt.PeripheralConductorDistribution.VerticalUpward_HorizontalRightward)
    cells[7].set_winding(winding8, 12, fmt.WindingType.Single, fmt.PeripheralConductorDistribution.VerticalUpward_HorizontalRightward)
    cells[8].set_winding(winding9, 13, fmt.WindingType.Single, fmt.PeripheralConductorDistribution.VerticalUpward_HorizontalRightward)
    cells[9].set_winding(winding10, 15, fmt.WindingType.Single, fmt.PeripheralConductorDistribution.VerticalUpward_HorizontalRightward)
    cells[10].set_winding(winding11, 11, fmt.WindingType.Single, fmt.PeripheralConductorDistribution.VerticalUpward_HorizontalRightward)
    cells[11].set_winding(winding12, 15, fmt.WindingType.Single, fmt.PeripheralConductorDistribution.VerticalUpward_HorizontalRightward)
