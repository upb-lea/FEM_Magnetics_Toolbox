...
def basic_example_transformer_electrostatic(onelab_folder: str = None, show_visual_outputs: bool = True, is_test: bool = False):
    ...
    insulation.add_winding_insulations([[0.025e-3, 0.095e-3],
                                        [0.095e-3, 0.025e-3]])
    insulation.add_conductor_air_conductor_insulation([[3.06e-4, 1.9285e-4, 1.9285e-4, 2.2777e-4],
                                                       [3.06e-4, 2.653e-4]])
    ...
    # 109-49
    cells = winding_window.NHorizontalAndVerticalSplit(horizontal_split_factors=[0.28],
    ...
    winding1.set_solid_round_conductor(1.3e-3, fmt.ConductorArrangement.Square)
    ...
    winding2.set_solid_round_conductor(1.3e-3, fmt.ConductorArrangement.Square)
    ...
    cells[1].set_winding(winding2, 6, None, fmt.Align.ToEdges, fmt.ConductorDistribution.VerticalUpward_HorizontalRightward, zigzag=True)
    ...
    cells[0].set_winding(winding1, 6, None, fmt.Align.ToEdges, fmt.ConductorDistribution.VerticalUpward_HorizontalRightward, zigzag=True)
    ...
    voltages_winding_1 = [1] * 10
    voltages_winding_2 = [1] * 10
