...
def basic_example_transformer_foil(onelab_folder: str = None, show_visual_outputs: bool = True, is_test: bool = False):
    ...
    #vww_bot.set_winding(winding1, 5, fmt.WindingScheme.FoilHorizontal, wrap_para_type=wrap_para_type)
    #vww_top.set_winding(winding2, 5, fmt.WindingScheme.FoilHorizontal, wrap_para_type=wrap_para_type)
