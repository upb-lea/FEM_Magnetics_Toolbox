...
# Load Data from Nikolas
frequency = 225000
I0 = 6.7  # 6 * 1.25  # 6 is peak of current wave_form
...
width = []  # [0.004]
N1 = [26, 27, 28]  # Turns in main window
N2 = [7, 8]  # Turns in main window
Ns1 = [7]  # Turns in stray window
Ns2 = [1, 2, 3, 4, 5, 6]  # Turns in stray window
...
for n_par, parameters in enumerate(FEM_parameters):
    ...
    if do_simulate:
        ...
        geo.core.update(type="EI",
                        ...
                        non_linear=True, material=95_100, re_mu_rel=mur)
