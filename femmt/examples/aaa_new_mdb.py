...
def basic_example_inductor(onelab_folder: str = None, show_visual_outputs: bool = False, is_test: bool = False):
    ...
    # core_material = fmt.LinearCoreMaterial(mu_r_abs=2500,
    #                                        phi_mu_deg=12,
    #                                        dc_conductivity=1,
    #                                        eps_r_abs=70000,
    #                                        phi_eps_deg=23,
    ...
    # If permittivity_datasource is selected as "custom", the data can be adjusted like follows:
    # core_material.eps_r_abs = 50000
    # core_material.phi_eps_deg = 23
    # core_material.dc_conductivity = 0.5
