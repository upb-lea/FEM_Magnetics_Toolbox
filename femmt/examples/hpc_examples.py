...
def create_parallel_example_inductor(inductor_frequency: int, air_gap_height: float = Testdata_Generator.airgapheight(),
    ...
    air_gaps.add_air_gap(fmt.AirGapLegPosition.CenterLeg, Testdata_Generator.airgapheight(),
                         Testdata_Generator.airgapposition(1))
    # sets second AirGap
    if Testdata_Generator.airgapnumber() == 2 or Testdata_Generator.airgapnumber() == 3:
        air_gaps.add_air_gap(fmt.AirGapLegPosition.CenterLeg, Testdata_Generator.airgapheight(),
                             Testdata_Generator.airgapposition(2))
    # sets third AirGap
    if Testdata_Generator.airgapnumber() == 3:
        air_gaps.add_air_gap(fmt.AirGapLegPosition.CenterLeg, Testdata_Generator.airgapheight(),
    ...
    vww.set_winding(winding, Winding_instance.get_shared_value(Testdata_Generator.SharedWindingNumber), None)
    geo.set_winding_windows([winding_window])
...
if __name__ == "__main__":
    ...
    Winding_instance = Testdata_Generator.SharedWindingNumber
    Results_instance = Testdata_Generator.ChangeFolder

    # ---- Preparing for Simulation loop ----
    Winding_instance.clear(Testdata_Generator.SharedWindingNumber)
    Model_instance.next(Testdata_Generator.Model_Values)
    print(Model_instance.next_sample_suggest)
    ...
    if execution_type == "default_example":
        for winding in range(20):
            ...
            print("Winding:", Winding_instance.get_shared_value(Testdata_Generator.SharedWindingNumber))
            ...
            Results_instance.copy_result_to_new_folder(Testdata_Generator.ChangeFolder)

            print(f"Execution time: {execution_time}")

            Winding_instance.increase_shared_value(Testdata_Generator.SharedWindingNumber)
...
#                                                     core_h=Testdata_Generator.coreheight())
#     core = fmt.Core(core_dimensions=core_dimensions, non_linear=False, correct_outer_leg=True,
#                     material=mdb.Material.N95, temperature=Testdata_Generator.temperature(),
#                     frequency=Testdata_Generator.frequency(),
#                     permeability_datasource=fmt.MaterialDataSource.Measurement,
#                     permeability_datatype=fmt.MeasurementDataType.ComplexPermeability,
#                     permeability_measurement_setup=mdb.MeasurementSetup.LEA_LK,
...
#     winding2.set_solid_round_conductor(conductor_radius=Testdata_Generator.conductorradius(),
#                                        conductor_arrangement=None)
#     vww.set_interleaved_winding(winding1, Testdata_Generator.windingturns(1), winding2,
#                                 Testdata_Generator.windingturns(2))
#     geo.set_winding_windows([winding_window])
#
#     return geo
#
...
#
# def create_parallel_example_inductor(inductor_frequency: int, air_gap_height: float = Testdata_Generator.airgapheight(),
#                                      air_gap_position: int = Testdata_Generator.airgapposition(
#                                          1)) -> fmt.MagneticComponent:
#     # Creates an example model which is used for the parallel execution example. This does implement a simple inductor with given inductor_frequency.
#
#     #:param inductor_frequency: Frequency for the inductor.
#     #:type inductor_frequency: int
...
#                                                     core_h=Testdata_Generator.coreheight())
#     core = fmt.Core(fmt.CoreType.Single, core_dimensions=core_dimensions,
#                     material=mdb.Material.N95, temperature=Testdata_Generator.temperature(), non_linear=False,
#                     correct_outer_leg=True,
#                     frequency=Testdata_Generator.frequency(),
#                     permeability_datasource=fmt.MaterialDataSource.Measurement,
#                     permeability_datatype=fmt.MeasurementDataType.ComplexPermeability,
#                     permeability_measurement_setup=mdb.MeasurementSetup.LEA_LK,
...
#     vww = winding_window.split_window(Testdata_Generator.windingwindowsplit())
#     winding = fmt.Conductor(0, fmt.Conductivity.Copper)
#     winding.set_solid_round_conductor(conductor_radius=Testdata_Generator.conductorradius(),
#                                       conductor_arrangement=Testdata_Generator.conductorarrangement())
#     # winding.set_litz_round_conductor(conductor_radius=Testdata_Generator.conductorradius(), number_strands=10, strand_radius=0.0001, fill_factor=None, conductor_arrangement=Testdata_Generator.conductorarrangement())
#     winding.parallel = False
#     vww.set_winding(winding, 1, fmt.WindingWindowSplit.NoSplit)
#     geo.set_winding_windows([winding_window])
#
#     return geo
#
...
#
#     model.create_model(freq=Testdata_Generator.frequency(), pre_visualize_geometry=False)
#     model.single_simulation(freq=Testdata_Generator.frequency(), current=current, phi_deg=phi_deg,
