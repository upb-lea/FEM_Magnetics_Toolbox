...
def basic_example_transformer_till(onelab_folder: str = None, show_visual_outputs: bool = True, is_test: bool = False):
    ...
    # -----------------------------------------------------------------------------------------------
    # # Simulation 5 (V_A, V_B, V_C, V_D = 1, 0, 1 , 0) --- (V_1, V_2, V_3, V_4 = 1, 1, 0, 0) # flip for terminal
    # V_A = 1.0
    # V_B = 0.0
    # V_C = 1.0
    # V_D = 0.0
    ...
    # ---------------------------------------------------------------
    # # Simulation 9 (V_A, V_B, V_C, V_D = 1, 1, 2 , 1) --- (V_1, V_2, V_3, V_4 = 0, 1, 0, 1) # flip for terminal
    # voltages_winding_1 = [1] * num_turns_w1
    # V_C = 2.0
    # V_D = 1.0
    # voltages_winding_2 = [
