...
def basic_example_inductor(onelab_folder: str = None, show_visual_outputs: bool = True, is_test: bool = False):
    ...
    core = fmt.Core(core_type=fmt.CoreType.Single,
                    ...
                    permittivity_datasource=fmt.MaterialDataSource.Custom, sigma=complex(0.06999999, 0.39999992))
    geo.set_core(core)
    ...
    insulation.add_core_insulations(0.001, 0.01, 0.004, 0.001)
