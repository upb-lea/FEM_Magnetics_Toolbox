...
def basic_example_inductor_measurement(onelab_folder: str = None, show_visual_outputs: bool = True, is_test: bool = False):
    ...
    insulation.add_core_insulations(1.55e-3, 1.55e-3, 1.5e-4, 1.5e-4)
    ...
    #                                                    [3.06e-4, 2.653e-4]])
    insulation.add_conductor_air_conductor_insulation([[1.0837e-4, 1.55e-4, 1.0837e-4, 1.0837e-4, 1.0837e-4],
                                                       [3.06e-4, 2.653e-4]])
    ...
    # voltages_winding_11 = [0] * 30 + [1] * 1 + [0] * 84
    # 8. create the model
    ...
    geo.electrostatic_simulation(voltage=[voltages_winding_11], core_voltage=1, ground_outer_boundary=False,
