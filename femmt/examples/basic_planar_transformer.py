...
def basic_example_planar_transformer(onelab_folder: str = None, show_visual_outputs: bool = True, is_test: bool = False):
    """
...
if __name__ == "__main__":
    basic_example_planar_transformer(show_visual_outputs=True)
